...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(DealerController::class)->group(function () {
        Route::get('/dealers-list/{type}', 'index')->name('dealers-list');
        Route::get('/edit-dealer/{id}', 'edit')->name('edit-dealer');
    });
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::post('/sellers/send_message', 'send_message')->name('sellers.send_message');
        Route::post('/sellers/submit_message', 'submit_message')->name('sellers.submit_message');
    });
    ...
    Route::group(['prefix' => 'website'], function() {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::get('/homepage-sections', 'homepage_sections')->name('website.homepage-sections');
            ...
            Route::get('/create-homepage-section', 'createHomepageSection')->name('create_homepage_section');
            Route::post('/save-homepage-section', 'storeSection')->name('save_homepage_section');
            Route::get('/edit-homepage-section/{id}', 'editHomepageSection')->name('edit_homepage_section');
            Route::post('/update-homepage-section/{id}', 'updateHomepageSection')->name('update_homepage_section');
            // Route::get('/get-homepage-sections', 'getHomePageSections')->name('get_homepage_sections');
        });
    ...
    // Doodle
    Route::resource('doodle', DoodleController::class);
    Route::controller(DoodleController::class)->group(function () {
        Route::get('/doodle/destroy/{id}', 'destroy')->name('doodle.destroy');
    });
