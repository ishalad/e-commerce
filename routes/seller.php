...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProfileController::class)->group(function () {
        ...
        Route::get('/admin_message', 'admin_message')->name('profile.message');
        Route::get('/show_message/{id}', 'show_message')->name('profile.show_message');
        Route::post('/submit_message', 'submit_message')->name('profile.submit_message');
    });
    ...
    // Pickup Address
    Route::resource('pickupaddresses', PickupAddressController::class);
    Route::controller(PickupAddressController::class)->group(function () {
        Route::post('/pickupaddresses/update/{id}', 'update')->name('pickupaddresses.update');
        Route::get('/pickupaddresses/destroy/{id}', 'destroy')->name('pickupaddresses.destroy');
        Route::get('/pickupaddresses/set_default/{id}', 'set_default')->name('pickupaddresses.set_default');
    });
