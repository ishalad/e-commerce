...
Route::controller(VerificationController::class)->group(function () {
    ...
    Route::get('/email-verification', 'email_verification')->name('email.verification');
});
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::get('/gst_details', 'gst_details')->name('gst_details');
        ...
        Route::post('/new-user-phone-verification', 'phone_verify')->name('user.phone.verify');
        Route::post('/phone-code-verify', 'phone_code_data')->name('phone.code.verify');
        Route::post('/new-user-gst', 'gst_verify')->name('user.gst_verify');
    });
...
Route::get('/verifications/{id}', [ShopController::class, 'phone'])->name('phone');
Route::post('/phone/store', [ShopController::class, 'phoneStore'])->name('phone.store');
Route::post('/verify/phone', [ShopController::class, 'phoneVerify'])->name('verify.phone');

Route::post('customer/verify/phone', [RegisterController::class, 'phoneVerify'])->name('customer.verify.phone');
...
Route::post('dealers/verify/phone', [DealerController::class, 'dealersPhoneVerify'])->name('dealers.verification');
Route::post('dealers/resendCode', [DealerController::class, 'resendCode'])->name('resendCode');

Route::get('/superdealer/dashboard', [DealerController::class, 'dealersDashboard'])->name('superdealer.dashboard');
Route::get('/superdealer/profile', [DealerController::class, 'superdealerProfile'])->name('superdealer.profile.index');
Route::post('/superdealer/profile/update/{id}', [DealerController::class, 'update'])->name('superdealer.profile.update');

Route::get('/superdealer/dealers', [DealerController::class, 'dealerList'])->name('superdealer.dealer.index');
Route::get('/superdealer/dealers/{id}/edit', [DealerController::class, 'edit'])->name('superdealer.dealers.edit');


Route::get('/dealer/dashboard', [DealerController::class, 'dealersDashboard'])->name('dealer.dashboard');
Route::get('/dealer/sellers', [DealerController::class, 'dealerList'])->name('dealer.sellers.index');
Route::get('/dealer/sellers/{id}/edit', [DealerController::class, 'edit'])->name('dealer.sellers.edit');
Route::post('/dealer/seller/profile/update/{id}', [DealerController::class, 'sellerupdate'])->name('dealer.seller.profile.update');
Route::get('/dealer/sellers/{id}/show', [DealerController::class, 'show'])->name('dealer.sellers.show');

Route::get('/influencer/dashboard', [DealerController::class, 'dealersDashboard'])->name('influencer.dashboard');
