...
class ProductController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('seller.product.products.create', compact('categories', 'pickupaddresses'));
    }
    ...
    public function store(ProductRequest $request)
    {
        ...
        $productData = Product::where('user_id', auth()->user()->id)->get(['id']);
        $productCount = $productData->count();
        
        if($productCount == 1) {
            $shop = Shop::where('user_id', auth()->user()->id)->first();
            $shop->product_status = 1;
            $shop->save();
        }
    ...
    {
        $product = Product::with('pickup_address')->findOrFail($id);
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        $pickupaddresses = Auth::user()->pickupaddresses;
        return view('seller.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'pickupaddresses'));
    }
