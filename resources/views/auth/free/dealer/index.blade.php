    ...
    <div class="aiz-main-wrapper d-flex flex-column justify-content-md-center bg-white">
        <section class="bg-white overflow-hidden" style="min-height:100vh;">
            <div class="row" style="min-height: 100vh;">
                ...
                <!-- Right Side -->
                <div class="col-xxl-6 col-lg-5  d-flex flex-column justify-content-center  right-content paddingBox border-0">
                    <div class="row align-items-center justify-content-center justify-content-lg-start h-100">
                        <div class="col-xxl-8 col-lg-8 p-4 p-lg-5">
                            <!-- Site Icon -->
                            <div class="mb-3 mx-auto mx-lg-0  logo-size">
                            ...
                            <ul class="tabForm nav nav-tabs mt-5 mb-3" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="supert-dealer-tab" data-bs-toggle="tab"
                                        data-bs-target="#super-dealer-tab-pane" type="button" role="tab"
                                        aria-controls="super-dealer-tab-pane"
                                        aria-selected="true">{{ translate('Super Dealer') }}</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="dealer-tab" data-bs-toggle="tab"
                                        data-bs-target="#dealer-tab-pane" type="button" role="tab"
                                        aria-controls="dealer-tab-pane"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="influencer-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="influencer-tab-pane"
                            ...
                            <div class="tab-content tabContent__wpr" id="myTabContent">
                                <div class="tab-pane fade show active" id="super-dealer-tab-pane" role="tabpanel"
                                    ...
                                    <form id="reg-super" class="form-default p-4" action="{{ route('dealers.store') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="phone"
                                                class="fs-12 fw-700 text-soft-dark">{{ translate('Your Phone') }}</label>
                                            <div class="form-group row">
                                                <div class="col-md-5 col-lg-5">
                                                    <select class="form-control aiz-selectpicker" data-live-search="true"
                                                        name="phone_code">
                                                        <option value="+91">
                                                            {{ translate('India') }}({{ translate('+91') }})
                                                        </option>
                                        ...
                                        <div class="form-group">
                                            <label for="email"
                                                class="fs-12 fw-700 text-soft-dark">{{ translate('Your Email') }}</label>
                                            <input type="email"
                                        ...
                                        <div class="form-group">
                                            <label for="business_name"
                                                class="fs-12 fw-700 text-soft-dark">{{ translate('Business Name') }}</label>
                                            <input type="text"
                                                class="form-control rounded-0{{ $errors->has('business_name') ? ' is-invalid' : '' }}"
                                                value="{{ old('business_name') }}"
                                                placeholder="{{ translate('Business Name') }}" name="business_name">
                                        ...
                                        <button type="submit"
                                            class="btn-primary btn-block fw-700 fs-14 rounded-0 submitBTN">{{ translate('Next') }}</button>
                                    </form>

                                </div>
                                <div class="tab-pane fade" id="dealer-tab-pane" role="tabpanel"
                                    aria-labelledby="dealer-tab" tabindex="0">
                                    <form id="reg-dealer" class="form-default p-4" role="form"
                                        action="{{ route('dealers.store') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="user_type" value="dealer">

                                        <div class="form-group">
                                            <label
                                                class="col-form-label fs-12 fw-700 text-soft-dark">{{ translate('Is Super Dealer ?') }}</label>
                                            <label class="aiz-switch aiz-switch-success">
                                                <input value="0" name="is_superdealer" id="is_superdealer"
                                                    type="checkbox">
                                ...
                                <div class="tab-pane fade" id="influencer-tab-pane" role="tabpanel"
                                    ...
                                    <form id="reg-influencer" class="form-default p-4" role="form"
                                        action="{{ route('dealers.store') }}" method="POST">
                                        @csrf
