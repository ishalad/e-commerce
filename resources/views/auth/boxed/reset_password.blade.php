                    ...
                    <div class="card shadow-none rounded-0 border-0">
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reset-password" class="form-default" action="{{ route('password.update') }}" method="POST">
                                            @csrf
                                            ...
                                            <!-- Code -->
                                            <div class="form-group">
                                                <input id="code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="code" value="{{ $email ?? old('code') }}" placeholder="{{translate('Code')}}" required>
