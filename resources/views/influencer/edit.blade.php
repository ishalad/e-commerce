...
<form action="{{ route('superdealer.profile.update', $dealear->id) }}" id="influencerEditForm" method="POST">
    @csrf
    <input type="hidden" name="dealer_page" value="dealer_edit">
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="text" name="name" value="{{ $dealear->name }}" id="name" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="text" name="phone" value="{{ $dealear->phone }}" id="phone" class="form-control" placeholder="{{ translate('Dealer Phone')}}">
                    @error('phone')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="email" name="email" value="{{ $dealear->email }}" id="email" class="form-control" placeholder="{{ translate('Dealer Email')}}">
                    @error('email')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="text" name="business_name" value="{{ $dealear->business_name }}" id="business_name" class="form-control" placeholder="{{ translate('Dealer Business Name')}}">
                    @error('business_name')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
