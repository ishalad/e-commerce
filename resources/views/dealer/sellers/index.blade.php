                    ...
                    <tbody>
                        @foreach ($sellers as $key => $seller)
                            <tr>
                                ...
                                <td>Temp</td>
                                <td class="text-right">
                                    <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('dealer.sellers.show', ['id'=>$seller->id])}}" title="{{ translate('View') }}">
                                        <i class="las la-eye"></i>
                                    </a>
                                    {{-- <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('dealer.sellers.edit', ['id'=>$seller->id])}}" title="{{ translate('Edit') }}">
