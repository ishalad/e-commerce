...
<form class="" action="{{route('seller.products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Product Unboxing Videos')}}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Package Dimensions') }}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Dimensions Unit') }}</label>
                        <div class="col-md-8">
                            <select class="form-control aiz-selectpicker" name="product_dimensions_unit" id="product_dimensions_unit">
                                <option value="">{{ translate('Select dimensions unit') }}</option>
                                <option value="Inches" @if($product->product_dimensions_unit == "Inches") selected @endif>{{ translate('Inches') }}</option>
                                <option value="CM" @if($product->product_dimensions_unit == "CM") selected @endif>{{ translate('CM') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Dimension') }}</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="product_dimension"
                                placeholder="{{ translate('Dimension') }}" value="{{ $product->product_dimension }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="product_height"
                                placeholder="{{ translate('Height') }}" value="{{ $product->product_height }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="product_weight"
                                placeholder="{{ translate('Weight') }}" value="{{ $product->product_weight }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Short Video') }}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Video 1') }}</label>
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="aizuploader" data-type="video"
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="video1" value="{{ $product->video1 }}" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Video 3') }}</label>
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="aizuploader" data-type="video"
                                data-multiple="true">
                                <div class="input-group-prepend">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="video2" value="{{ $product->video2 }}" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="input-group" data-toggle="aizuploader" data-type="video"
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="video3" value="{{ $product->video3 }}" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="product_specification">{{ $product->product_specification }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('ReturnPolicy') }}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group mb-3">
                        <select class="form-control aiz-selectpicker" name="return_policy" id="return_policy">
                            <option value="noreturn" @if($product->return_policy == "noreturn") selected @endif>{{ translate('No return') }}</option>
                            <option value="7days" @if($product->return_policy == "7days") selected @endif>{{ translate('7 Days') }}</option>
                            <option value="14days" @if($product->return_policy == "14days") selected @endif>{{ translate('14 Days') }}</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('Other') }}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-md-6 col-from-label">{{translate('Is made in india?')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="made_in_india" value="1"
                                            @if($product->made_in_india == 1) checked @endif>
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-md-6 col-from-label">{{translate('Is handmade?')}}</label>
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="handmade" value="1"
                                            @if($product->handmade == 1) checked @endif>
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row gutters-10">
                        @foreach ($pickupaddresses as $key => $address)
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <label class="w-100" for="pickup_address_{{ $address->id }}">
                                    <div class="border p-3 pr-2 rounded mb-3 position-relative">
                                        <input type="radio" name="pickup_addresse_id" id="pickup_address_{{ $address->id }}" value="{{ $address->id }}" {{ $address->id == $product->pickup_address->id ? 'checked' : '' }}>
