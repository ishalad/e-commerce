                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="product_dimensions_unit" id="product_dimensions_unit">
                                        ...
                                        <option value="Inches">{{ translate('Inches') }}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="product_dimension"
                                        placeholder="{{ translate('Dimension') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="video"
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="video1" class="selected-files">
                                    </div>
                                    <div class="file-preview box sm">
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea class="aiz-text-editor" name="product_specification"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                <select class="form-control aiz-selectpicker" name="return_policy" id="return_policy">
                                    <option value="noreturn">{{ translate('No return') }}</option>
                                    <option value="7days">{{ translate('7 Days') }}</option>
                                    <option value="14days">{{ translate('14 Days') }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <label class="w-100" for="pickup_address_{{ $address->id }}">
                                        <div class="border p-3 pr-2 rounded mb-3 position-relative">
                                            <input type="radio" name="pickup_addresse_id" id="pickup_address_{{ $address->id }}" value="{{ $address->id }}">
...
<script type="text/javascript">
    ...
    function update_sku() {
        $.ajax({
            ...
            // console.debug($('#sku_combination').html());
