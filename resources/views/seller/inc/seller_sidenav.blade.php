<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        @if(Auth::user()->is_profile == 1 && Auth::user()->shop->verification_status == 1)
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @endif
                @php
                $unread_count = \App\Models\AdminMessage::where('receiver_id', Auth::user()->id)
                    ->where('is_view', 0)
                    ->get();
                @endphp
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.profile.message') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['seller.profile.show_message', 'seller.profile.message']) }}">
                        <i class="las la-comment aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Admin Message') }}</span>
                        @if (count($unread_count) > 0)
                            <span class="badge badge-success">({{ count($unread_count) }})</span>
                        @endif
                    </a>
                </li>
