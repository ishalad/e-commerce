            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('dealers-list','super_dealer')}}">
                                <span class="aiz-side-nav-text">{{translate('Super Dealer')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('dealers-list','dealer')}}">
                                <span class="aiz-side-nav-text">{{translate('Dealer')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('dealers-list','influencer')}}">
                ...
                @canany(['view_blogs','view_blog_categories'])
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Doodle') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_blogs')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('doodle.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['doodle.create', 'doodle.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('All Doodle') }}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance','authentication_layout_settings'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('homepage_sections')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('website.homepage-sections') }}" class="aiz-side-nav-link">
                            ...
                            @can('vat_&_tax_setup')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('tax.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['tax.index', 'tax.create', 'tax.store', 'tax.show', 'tax.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('GST & TAX')}}</span>
                                    </a>
                                </li>
                            @endcan
