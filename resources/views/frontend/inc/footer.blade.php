    ...
    <div class="container">
        ...
        <div class="mt-3 mb-4">
            <a href="{{ route('home') }}" class="d-block">
                ...
                @else
                    <img class="lazyload h-45px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.svg') }}" alt="{{ env('APP_NAME') }}" height="45">
                @endif
            </a>
        </div>
        <div class="row">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <p class="fs-13 text-soft-light mb-0">
                                    ...
                                    <a href="{{ route('dealers.create') }}" class="fs-13 fw-700 text-secondary-base ml-2">{{ translate('Apply Now') }}</a>
                                </p>
                            </li>
                            @guest
                                <li class="mb-2">
